...
publication: "***Journal of Computer Applications** , 42* (7) [CCF C]"
publication_short: ""
...
summary: Internet of Things (IoT), edge computing, blockchain, access control, attribute access, signature authentication.
...
# - name: ""
#   url: ""
url_pdf: 'http://www.joca.cn/EN/10.11772/j.issn.1001-9081.2021040626'
url_code: ''
url_dataset: ''
url_poster: ''
url_project: ''
...
---
[Download paper here](https://jackaugust.github.io/files/Internet_of_things_access_control_model_based_on_blockchain_and_edge_computing.pdf)

This paper is about IoT security. In the cloud-edge-end architecture, try to implement access control based on blockchain and give a SC-ABAC model and a simple prototype. SC-ABAC is Smart Contract for Attribute-Based Access Control, and the POW consensus algorithm has been improved in the prototype.

**Congratulations!!!**  
Until November 17, 2023, this paper was selected as a China Knowledge Network Academic Essentials **Highly Cited Paper** and **Highly Downloaded Paper**.
